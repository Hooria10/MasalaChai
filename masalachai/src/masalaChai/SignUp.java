...
public class SignUp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(-20, -10, 820, 980));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
     ...
     String pNum = phonenotxt.getText();
    ...
    if (usernametxt.getText().equals("") || passwordtxt.getText().equals("") || emailtxt.getText().equals("") ){
       ...
       JOptionPane.showMessageDialog(rootPane, "You must be older than 4 years to purchase our Chai");
        ...
        JOptionPane.showMessageDialog(rootPane, "You have signed in. Welcome to MasalaChai");
